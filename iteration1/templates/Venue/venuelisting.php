    ...
    <head>
        ...
        <section class="py-5">
            ...
            <div class="text-center">
                 <?= $this->Form->postLink(
                   'Send Request',
                  ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[0]['id'],'name'=>$data[0]['name'],'price'=>$data[0]['price'],'service'=>$data[0]['service']]], // Modify the URL as needed
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[1]['id'],'name'=>$data[1]['name'],'price'=>$data[1]['price'],'service'=>$data[1]['service']]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[2]['id'],'name'=>$data[2]['name'],'price'=>$data[2]['price'],'service'=>$data[2]['service']]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[3]['id'],'name'=>$data[3]['name'],'price'=>$data[3]['price'],'service'=>$data[3]['service'] ]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[4]['id'],'name'=>$data[4]['name'],'price'=>$data[4]['price'],'service'=>$data[4]['service']]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[5]['id'],'name'=>$data[5]['name'],'price'=>$data[5]['price'],'service'=>$data[5]['service']]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[6]['id'],'name'=>$data[6]['name'],'price'=>$data[6]['price'],'service'=>$data[6]['service']]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                <?= $this->Form->postLink(
                                              'Send Request',
                                              ['controller' => 'Booking', 'action' => 'clientBook', '?' => ['venue_id' => $data[7]['id'],'name'=>$data[7]['name'],'price'=>$data[7]['price']]], // Modify the URL as needed
                                                ['class' => 'btn btn-outline-dark mt-auto', 'id' => 'sendRequestButton']
                                                 ) ?>
                                </div>
                            </div>
